    ...
    public ManageDoctorsFrame() {
        ...
        btnAddDoctor.addActionListener(e -> {
            ...
            if (txtName.getText().trim().isEmpty() ||
                ...
                String checkQuery = "SELECT COUNT(*) FROM hmsuser WHERE user_username = ?";
                ...
                String insertUserQuery = "INSERT INTO hmsuser (user_role, user_username, user_password, user_name) " +
                        "VALUES (?, ?, ?, ?)";
                ...
                try (PreparedStatement insertUserStmt = conn.prepareStatement(insertUserQuery)) {
                    ...
                    // Get the doctor ID
                    String getDoctorIdQuery = "SELECT user_id FROM hmsuser WHERE user_username = ?";

                    try (PreparedStatement getDoctorStmt = conn.prepareStatement(getDoctorIdQuery)) {
                        ...
                        if (rs.next()) {
                            ...
                            String insertDoctorQuery = "INSERT INTO doctor (doctor_id, doctor_specialisation) VALUES (?, ?)";

                            try (PreparedStatement insertDoctorStmt = conn.prepareStatement(insertDoctorQuery)) {
        ...
        btnAssignSpecialisation.addActionListener(e -> {
            ...
            String updateQuery = "UPDATE doctor SET doctor_specialisation = ? WHERE doctor_id = ?";
